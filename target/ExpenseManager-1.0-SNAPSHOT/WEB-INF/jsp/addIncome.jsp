<%-- 
    Document   : addIncome
    Created on : Aug 19, 2022, 3:23:25 PM
    Author     : USER
--%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<h1 class="text-center text-info mt-4 pt-4">ADD NEW INCOME</h1>

<c:url value="/user/income" var="action" />
        ...
        <div class="col">
            ...
            <form:select id="cate" path="categoryId" class="form-select">
                <c:forEach items="${categories}" var="c">
                    <option value="${c.id}">${c.name2}</option>
                </c:forEach>
            </form:select>
        </div>
        <div class="col">
